        ...
        var e = function(t) {
            ...
            return __extends(e, t), e.prototype.invalidateProperties = function(t) {
                ...
                for (var r = this.invalidatePropertiesQueue, o = this.invalidateSizeQueue, s = this.invalidateDisplayListQueue; !i;) {
                    for (i = !0, e = r.removeSmallestChild(t); e;) e.$stage && e.validateProperties(), e = r.removeSmallestChild(t);
            ...
            return Object.defineProperty(t.prototype, "states", {
                ...
                if (t.parent) {
                    ...
                    if (t.oldState != t.currentState) {
                        ...
                        if (n)
                            for (var r = n.overrides, o = r.length, s = 0; o > s; s++) r[s].remove(this, i);
                        if (t.oldState = t.currentState, n = t.statesMap[t.currentState])
                            for (var r = n.overrides, a = r.length, s = 0; a > s; s++) r[s].apply(this, i)
                    }
                }
    ...
    var e = function(e) {
        ...
        return __extends(i, e), Object.defineProperty(i.prototype, "hostComponentKey", {
            ...
            if (e)
                ...
                else if (i = egret.getDefinitionByName(e), !i && -1 != n.toLowerCase().indexOf(".exml")) return void EXML.load(e, this.onExmlLoaded, this, !0);
                i && (t = new i)
            } else t = e;
            this.setSkin(t)
...
! function(t) {
    var e = function(e) {
        ...
        return __extends(i, e), Object.defineProperty(i.prototype, "useVirtualLayout", {
            ...
            var e, i = this.itemToRendererClass(t),
                n = i.$hashCode,
                r = this.$DataGroup,
                o = r[3];
            ...
            for (var i = t.length, n = i - 1; n >= 0; n--) this.itemRemoved(t[n], e + n);
            this.resetRenderersIndices()
            ...
            if (0 != t.length)
                if (this.$layout && this.$layout.$useVirtualLayout)
                    for (var e = Object.keys(t), i = e.length, n = 0; i > n; n++) {
                        ...
                        for (var o = t.length, r = 0; o > r; r++) this.resetRendererItemIndex(r)
            ...
            if ((i[5] || this.$dataProviderChanged || i[1]) && (this.removeAllRenderers(), this.$layout && this.$layout.clearVirtualLayoutCache(), this.setTypicalLayoutRect(null), i[1] = !1, i[5] = !1, this.$dataProvider && this.$dataProvider.addEventListener(t.CollectionEvent.COLLECTION_CHANGE, this.onCollectionChange, this), this.$layout && this.$layout.$useVirtualLayout ? (this.invalidateSize(), this.invalidateDisplayList()) : this.createRenderers(), this.$dataProviderChanged && (this.$dataProviderChanged = !1, this.scrollV = this.scrollH = 0)), e.prototype.commitProperties.call(this), i[8] && (i[8] = !1, this.$dataProvider && this.$dataProvider.length > 0 && (i[12] = this.$dataProvider.getItemAt(0), this.measureRendererSize())), i[14]) {
                ...
                for (var a = 0; s > a; a++)
                    for (var u = o[a], p = l[u], c = p.length, d = 0; c > d; d++) this.setItemRenderSkinName(p[d], n)
            }
        }, i.prototype.measure = function() {
        ...
        var n = [],
            ...
            m = function() {
                ...
                return e.prototype.$parseCode = function(t, e) {
                    ...
                    var n = i.lastIndexOf("."); - 1 != n ? this.currentClass.className = i.substring(n + 1) : this.currentClass.className = i, this.startCompile();
                    ...
                    if (e)
                        for (var i = e.length, n = 0; i > n; n++) {
                            var r = e[n];
                            if (1 == r.nodeType && r.namespace && !this.isInnerClass(r))
                                if (this.addIds(r.children), r.namespace != t.NS_W && r.localName) {
                    ...
                    if (o && 0 != o.length) {
                        for (var s, a = t.exmlConfig.getClassNameById(e.localName, e.namespace), h = [], l = o.length, u = [], p = 0; l > p; p++) {
                            var c = o[p];
                            if (1 == c.nodeType && c.namespace != t.NS_W)
                    ...
                    if (p > 1) {
                        ...
                        if (e == u)
                            if (y.localName == u) {
                                var c = [];
                                if (y.children)
                                    for (var g = y.children.length, v = 0; g > v; v++) {
                                        var f = y.children[v];
                                        if (1 == f.nodeType) {
                                            h = this.createFuncForNode(f);
                                            this.getClassNameOfNode(f);
                    ...
                    if (n && 1 === e.nodeType && e.parent && !this.isBasicTypeData(n)) {
                        var r = e.parent,
                            o = n.indexOf("."); - 1 != o && (n = n.substr(0, o));
                        var s = t.exmlConfig.getClassNameById(r.localName, r.namespace);
                    ...
                    if (a) {
                        ...
                        i = "new " + h + "(" + i + ")"
                    } else if (s == p) - 1 != i.indexOf("%") && (i = this.formatString(i));
                    else {
                        switch (s) {
                            case l:
                    ...
                    for (var o = t.split("+"), s = o.length, a = 0; s > a; a++) o[a] = o[a].split("1").join("+");
                    return o
                    ...
                    if (u.length > 0) {
                        l = u.length;
                        for (var o = 0; l > o; o++) h = u[o], e.addCodeLine("this." + h + "_i();");
                        e.addEmptyLine()
                    }
                    var p = this.skinParts,
                        c = "[]";
                    if (l = p.length, l > 0) {
                        for (var o = 0; l > o; o++) p[o] = '"' + p[o] + '"';
                        c = "[" + p.join(",") + "]"
                    }
                    ...
                    if (n == c) {
                        ...
                        if (o || r)
                            if (r)
                                for (var p = r.split(","), d = p.length, u = 0; d > u; u++) {
                                    var f = p[u].trim();
                                    f && (-1 == a.indexOf(f) && a.push(f), this.stateCode.push(new t.EXState(f)))
                                } else
                                    for (var y = o.length, u = 0; y > u; u++) {
                                        var g = o[u];
                                        if (1 == g.nodeType) {
                                            var v = [],
                                                m = g.attributes;
                                            if (m.stateGroups)
                                                for (var $ = m.stateGroups.split(","), E = $.length, C = 0; E > C; C++) {
                                                    var _ = $[C].trim();
                                                    _ && (-1 == a.indexOf(_) && a.push(_), v.push(_))
                                                }
                                            var f = m.name; - 1 == a.indexOf(f) && a.push(f), this.stateCode.push(new t.EXState(f, v))
                                        }
                                    }
                    }
                    ...
                    if (i)
                        for (var n = i.length, r = 0; n > r; r++) {
                            var o = i[r];
                            if (1 == o.nodeType && !this.isInnerClass(o) && (this.createStates(o), o.namespace != t.NS_W && o.localName))
                                ...
                                if (this.isStateNode(o)) {
                                    ...
                                    var _ = this.findNearNodeId(o),
                                        b = [];
                                    if (m.includeIn) b = m.includeIn.split(",");
                                    else {
                                        ...
                                        for (var g = 0; T > g; g++) v = this.stateCode[g], -1 == S.indexOf(v.name) && b.push(v.name)
                                    }
                                    for (var I = b.length, P = 0; I > P; P++)
                                        if (l = b[P], f = this.getStateByName(l, o), f.length > 0)
                                            for (var y = f.length, g = 0; y > g; g++) v = f[g], v.addOverride(new t.EXAddItems($, E, _.position, _.relativeTo))
                                }
                                for (var L = Object.keys(m), N = L.length, O = 0; N > O; O++) {
                                    ...
                                    if (-1 != a) {
                                        ...
                                        var y = f.length;
                                        if (y > 0)
                                            for (var g = 0; y > g; g++) v = f[g], B ? v.addOverride(new t.EXSetStateProperty($, D, B.templates, B.chainIndex)) : v.addOverride(new t.EXSetProperty($, D, d))
                                    }
                                }
                            }
                        }
    ...
    var e = [],
        ...
        r = function() {
            ...
            return t.prototype.getAsset = function(t, r, o) {
                ...
                var a = e.pop();
                a || (a = new egret.ImageLoader), i[t] = [
                    [r, o]
                ], n[a.$hashCode] = t, a.addEventListener(egret.Event.COMPLETE, this.onLoadFinish, this), a.addEventListener(egret.IOErrorEvent.IO_ERROR, this.onLoadFinish, this), a.load(t)
    ...
    var e = function(e) {
        ...
        return __extends(i, e), Object.defineProperty(i.prototype, "selectedIndices", {
            ...
            get: function() {
                ...
                if (e)
                    for (var i = e.length, n = 0; i > n; n++) t[n] = this.$dataProvider.getItemAt(e[n]);
                return t
            },
            set: function(t) {
                var e = [];
            ...
            if (r.length > 0 && o.length > 0) {
                for (e = o.length, t = 0; e > t; t++) - 1 == r.indexOf(o[t]) && n.push(o[t]);
                for (e = r.length, t = 0; e > t; t++) - 1 == o.indexOf(r[t]) && i.push(r[t])
            ...
            if (n > 0) {
                ...
                for (var r = !1, o = 0; n > o; o++) i[o] == t ? r = !0 : i[o] != t && e.splice(0, 0, i[o]);
...
! function(t) {
    var e = function(e) {
        ...
        return __extends(i, e), Object.defineProperty(i.prototype, "layout", {
            ...
            var r = this.selectedIndex; - 1 == r ? this.setSelectedIndex(n) : n <= this.selectedIndex && this.$stage && this.setSelectedIndex(r + 1), t.CollectionEvent.dispatchCollectionEvent(this, t.CollectionEvent.COLLECTION_CHANGE, t.CollectionEventKind.ADD, n, -1, [i.name])
    ...
    var n = "__listeners__",
        ...
        s = function() {
            ...
            return s.watch = function(t, e, i, n) {
                ...
                var i = this.host;
                if (i)
                    if (egret.is(i, "egret.IEventDispatcher")) i.removeEventListener(t.PropertyEvent.PROPERTY_CHANGE, this.wrapHandler, this);
                    else {
                        var r = i[n],
                            o = r.indexOf(this);
                        r.splice(o - 1, 2)
                ...
                if (this.host = e, e)
                    if (s.checkBindable(e, this.property), egret.is(e, "egret.IEventDispatcher")) e.addEventListener(t.PropertyEvent.PROPERTY_CHANGE, this.wrapHandler, this, !1, 100);
                    else {
                        var r = e[n];
...
! function(t) {
    var e = function(e) {
        ...
        return __extends(i, e), Object.defineProperty(i.prototype, "source", {
            ...
            for (var n = 0; e > n; n++) n >= i ? this.addItemAt(t[n], n) : this.replaceItemAt(t[n], n);
            this._source = t
            ...
            l = function() {
                ...
                return l.prototype.isPlaying = function() {
                    ...
                    var f = i / p,
                        ...
                        v = 0;
                    if (y > o)
                        if (v = t + (f - o) / h * 2 * this.$scrollFactor, 0 > v || v > e)
                            for (v = t; Math.abs(f) > o;) v -= f, f *= 0 > v || v > e ? s * a : s, g++;
...
! function(t) {
    var e = function(e) {
        ...
        return __extends(i, e), i.prototype.load = function(e) {
            ...
            var l = e.paths;
            for (var u in l) EXML.update(u, l[u]);
                ...
                return l.prototype.$describe = function(t) {
                    ...
                    for (var c = Object.keys(i).concat(Object.keys(t)), d = c.length, f = t.__meta__, y = 0; d > y; y++) {
                        ...
                        if ("constructor" != g && "_" != g.charAt(0) && "$" != g.charAt(0)) {
                            var v = void 0;
                            if (f && f[g]) v = f[g];
                            else if (e(t[g])) v = "Array";
                            else {
                                if (v = typeof t[g], "function" == v) continue; - 1 == o.indexOf(v) && (v = "any")
                            }
                            r[g] = v
                        }
                    }
                    ...
                    var n, r = this.getClassNameById(t, e),
                        o = i(r);
            ...
            return __extends(n, i), n.prototype.measureReal = function() {
                ...
                for (y = 0; m > y; y++) {
                    ...
                    if (egret.is(P, e) && P.$includeInLayout)
                        if (P.getPreferredBounds(I), x = Math.max(x, I.height), c) _ += I.width;
                        else {
                            var L = P.$UIComponent;
                ...
                if (c) {
                    if (0 > O) {
                        for (N = T / $, y = 0; m > y; y++) g = r.getElementAt(y), egret.is(g, e) && g.$includeInLayout && (g.getPreferredBounds(I), I.width <= N && (T -= I.width, A--));
                        T = T > 0 ? T : 0
                    }
                } else if (b > 0) {
                ...
                for (y = 0; m > y; y++) {
                    ...
                    if (g = r.getElementAt(y), egret.is(g, e) && g.$includeInLayout) {
                        if (g.getPreferredBounds(I), k = 0 / 0, c ? (F = 0 / 0, O > 0 ? F = T * I.width / _ : 0 > O && I.width > N && (F = T / A), isNaN(F) || (k = Math.round(F + G), G += F - k)) : k = D[g.$hashCode], d) C = a, g.setLayoutBoundsSize(k, U), g.getLayoutBounds(I);
                        else {
                            var W = 0 / 0,
                                L = g.$UIComponent;
                ...
                if (d) {
                    for (var b = this.startIndex; p >= b; b++) y = r.getVirtualElementAt(b), egret.is(y, e) && y.$includeInLayout && (y.getPreferredBounds(g), C = Math.max(C, g.height));
        ...
        i = function(i) {
            ...
            return __extends(n, i), Object.defineProperty(n.prototype, "horizontalGap", {
                ...
                var d = this._orientation == t.TileOrientation.COLUMNS,
                    ...
                    m = this._paddingTop,
                    $ = this._paddingBottom;
                if (this._requestedColumnCount > 0 || this._requestedRowCount > 0) this._requestedRowCount > 0 && (this._rowCount = Math.min(this._requestedRowCount, a)), this._requestedColumnCount > 0 && (this._columnCount = Math.min(this._requestedColumnCount, a));
                else if (f || y)
                    if (!f || y && d) {
                ...
                var l, u = h - this._rowHeight * this._rowCount,
        ...
        i = function(i) {
            ...
            return __extends(n, i), n.prototype.measureReal = function() {
                ...
                for (y = 0; m > y; y++) {
                    var P = r.getElementAt(y);
                    if (egret.is(P, e) && P.$includeInLayout)
                        if (P.getPreferredBounds(I), x = Math.max(x, I.width), c) _ += I.height;
                        else {
                            var L = P.$UIComponent;
                ...
                if (c) {
                    if (0 > O) {
                        for (N = T / $, y = 0; m > y; y++) g = r.getElementAt(y), egret.is(g, e) && g.$includeInLayout && (g.getPreferredBounds(I), I.height <= N && (T -= I.height, A--));
                        T = T > 0 ? T : 0
                    }
                } else if (b > 0) {
                ...
                for (y = 0; m > y; y++) {
                    var j = 0;
                    if (g = r.getElementAt(y), egret.is(g, e) && g.$includeInLayout) {
                        if (g.getPreferredBounds(I), k = 0 / 0, c ? (F = 0 / 0, O > 0 ? F = T * I.height / _ : 0 > O && I.height > N && (F = T / A), isNaN(F) || (k = Math.round(F + G), G += F - k)) : k = D[g.$hashCode], d) E = o, g.setLayoutBoundsSize(U, k), g.getLayoutBounds(I);
                        else {
                            var W = 0 / 0,
                                L = g.$UIComponent;
                            if (!isNaN(L[6])) {
                ...
                if (d) {
                    for (var b = this.startIndex; p >= b; b++) y = r.getVirtualElementAt(b), egret.is(y, e) && y.$includeInLayout && (y.getPreferredBounds(g), C = Math.max(C, g.width));
                    m = Math.ceil(Math.max(v, C))
                }
                for (var S, T = 0, x = 0, I = 0, P = !1, L = this.elementSizeTable, N = this.startIndex; p >= N; N++) {
                    var O = 0;
