    ...
    ! function(t) {
        var r = function(r) {
            ...
            return __extends(i, r), Object.defineProperty(i.prototype, "length", {
                ...
                function r() {
                    i.$recycle(this.url, s), a(), c.indexOf("firefox") >= 0 && (s.pause(), s.muted = !1), o.loaded = !0, o.dispatchEventWith(e.Event.COMPLETE)
                }
                ...
                function a() {
                    s.removeEventListener("canplaythrough", r), s.removeEventListener("error", n), c.indexOf("edge") >= 0 && document.body.removeChild(s)
                }
                var o = this;
                this.url = t;
                var s = new Audio(t);
                ...
                c.indexOf("firefox") >= 0 && (s.autoplay = !0, s.muted = !0), c.indexOf("edge") >= 0 && document.body.appendChild(s), s.load(), this.originAudio = s, i.clearAudios[this.url] && delete i.clearAudios[this.url]
                ...
                if (r) {
                    ...
                    i.once(e.Event.COMPLETE, function(r) {
                        ...
                        if (t.posterData = i.data, t.$renderDirty = !0, t.posterData.width = t.getPlayWidth(), t.posterData.height = t.getPlayHeight(), e.nativeRender) {
                            var n = new e.Texture;
                            n._setBitmapData(t.posterData), t.$nativeDisplayObject.setBitmapData(n)
                        }
                    }, this), i.load(r)
                }
            ...
            return e.prototype.reachMaxSize = function(e, t) {
                ...
                if (d) {
                    var R = this.vertices,
                        ...
                        B = 0,
                        O = 0;
                    for (D = 0, A = u.length; A > D; D += 2) $ = L + 5 * D / 2, B = d[D], O = d[D + 1], M = u[D], I = u[D + 1], R[$ + 0] = y * B + m * O + w, R[$ + 1] = x * B + b * O + E, p ? (R[$ + 2] = (t + (1 - I) * n) / l, R[$ + 3] = (r + M * i) / h) : (R[$ + 2] = (t + M * i) / l, R[$ + 3] = (r + I * n) / h), R[$ + 4] = v;
                    if (this.hasMesh)
                    ...
                    if (p) {
                        var N = i;
                        i = n / F, n = N / G, R[L++] = w, R[L++] = E, R[L++] = i + t, R[L++] = r, R[L++] = v, R[L++] = y * H + w, R[L++] = x * H + E, R[L++] = i + t, R[L++] = n + r, R[L++] = v, R[L++] = y * H + m * k + w, R[L++] = b * k + x * H + E, R[L++] = t, R[L++] = n + r, R[L++] = v, R[L++] = m * k + w, R[L++] = b * k + E, R[L++] = t, R[L++] = r, R[L++] = v
                    } else i /= F, n /= G, R[L++] = w, R[L++] = E, R[L++] = t, R[L++] = r, R[L++] = v, R[L++] = y * H + w, R[L++] = x * H + E, R[L++] = i + t, R[L++] = r, R[L++] = v, R[L++] = y * H + m * k + w, R[L++] = b * k + x * H + E, R[L++] = i + t, R[L++] = n + r, R[L++] = v, R[L++] = m * k + w, R[L++] = b * k + E, R[L++] = t, R[L++] = n + r, R[L++] = v;
                    if (this.hasMesh) {
                ...
                return a.prototype.render = function(t, r, i, a) {
                    ...
                    if (d || t.$children && 0 != t.$children.length) {
                        ...
                        if (m.context.setGlobalCompositeOperation(i), m.context.popBuffer(), l > 0) {
                            ...
                            var C = m.rootRenderTarget.width,
                                R = m.rootRenderTarget.height;
                            a.context.drawTexture(m.rootRenderTarget.texture, 0, 0, C, R, 0, 0, C, R, C, R), u && m.context.popMask(), h && a.context.setGlobalCompositeOperation(i);
                    ...
                    if (t.$hasScissor || 0 != o.b || 0 != o.c) t.context.pushMask(a.x + r, a.y + i, a.width, a.height);
                        ...
                        if (1 == l && 1 == h) y = f + u, x = p + d, m = v + u, b = g + d;
                            ...
                            var w = l * f + u,
                                ...
                                L = h * g + d,
                                D = 0;
                            w > T && (D = w, w = T, T = D), _ > R && (D = _, _ = R, R = D), y = _ > w ? w : _, m = T > R ? T : R, E > S && (D = E, E = S, S = D), C > L && (D = C, C = L, L = D), x = C > E ? E : C, b = S > L ? S : L
                        }
