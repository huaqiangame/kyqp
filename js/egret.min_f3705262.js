...
! function(t) {
    ...
    var e = function(e) {
        ...
        return __extends(i, e), Object.defineProperty(i.prototype, "textureWidth", {
            ...
            this.$bitmapData && (this.disposeBitmapData && this.$bitmapData.$dispose(), this.$bitmapData = null), t.nativeRender && egret_native.NativeDisplayObject.disposeTexture(this)
        }, i
    }(t.HashObject);
...
! function(t) {
    var e = function(e) {
        ...
        return __extends(i, e), i.create = function(e, r, n) {
            var a = "";
            ...
            "webgl" == t.Capabilities.renderMode && this.webGLTexture && (t.WebGLUtils.deleteWebGLTexture(this.webGLTexture), this.webGLTexture = null), this.source && this.source.dispose && this.source.dispose(), this.source = null, i.$dispose(this)
            ...
            if (e) {
                ...
                if (r && i._displayList[r]) {
                    ...
                    t.nativeRender && egret_native.NativeDisplayObject.disposeBitmapData(e), delete i._displayList[r]
                }
            }
...
function(t) {
    if (t.nativeRender = __global.nativeRender, t.nativeRender) {
        ...
        if (r > e) {
            t.nativeRender = !1;
            var n = "需要升级微端版本到 0.1.8 才可以开启原生渲染加速";
    ...
    ! function(e) {
        ...
        var i = function() {
            ...
            return i.prototype.$addPlayer = function(t) {
                ...
                for (var p = 0; a > p; p++) r[p].call(n[p], s) && (o = !0);
                var d = t.getTimer(),
                    f = s - this.lastTimeStamp;
                if (this.lastTimeStamp = s, f >= this.frameDeltaTime) this.lastCount = this.frameInterval;
                else {
...
! function(t) {
    ...
    var i = function() {
        function e() {}
        return e.language = "zh-CN", e.os = "Unknown", e.runtimeType = t.RuntimeType.WEB, e.engineVersion = "5.2.12", e.renderMode = "Unknown", e.boundingClientWidth = 0, e.boundingClientHeight = 0, e
    }();
